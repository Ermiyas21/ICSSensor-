...
# #### Hyperparameter tuning for 30 second logs using Isolation forest - HAI data set   
...
if_model = IsolationForest(n_estimators=5 ,max_samples=5,max_features= 10,contamination=0.1,random_state=47).fit(X_train)
...
plt.xlabel("P1_FCV02D")
plt.ylabel("P1_FCV01Z") 
